namespace Core.Catalog.Shared.Constants
{
    public static class Generals
    {
        ...
        {
            public const string NameSpacesObjectCatalogBilling = "Heifer.Model.Entity.CatalogsBilling";
            public const string NameSpacesObjectApp = "Heifer.Model.Entity.App";
        }
